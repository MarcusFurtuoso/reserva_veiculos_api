...
CREATE TABLE imv_imagem_veiculo
(
...
ALTER TABLE imv_imagem_veiculo
    ADD CONSTRAINT imv_imagens_veiculos_vei_veiculos
...
ALTER TABLE usp_usuario_perfil
    ADD CONSTRAINT usp_usuario_perfil_per_perfil
...
ALTER TABLE usp_usuario_perfil
    ADD CONSTRAINT usp_usuario_perfil_usu_usuario
...
ALTER TABLE vus_veiculo_usuario
    ADD CONSTRAINT vus_veiculo_usuario_usu_usuario
        FOREIGN KEY (usu_nr_id)
            REFERENCES usu_usuario (usu_nr_id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
...
ALTER TABLE vus_veiculo_usuario
    ADD CONSTRAINT vus_veiculo_usuario_vei_veiculos
        FOREIGN KEY (vei_nr_id)
            REFERENCES vei_veiculo (vei_nr_id)
            NOT DEFERRABLE
                INITIALLY IMMEDIATE
